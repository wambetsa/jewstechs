                ...
                <div class="flex flex-col break-words bg-white border border-2 rounded shadow-md">
                    ...
                    <form class="w-full p-6" method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="flex flex-wrap mb-6">
                            ...
                            <input id="email" type="email" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline{{ $errors->has('email') ? ' border-red' : '' }}" name="email" value="{{ old('email') }}" placeholder="Enter your email address" required autofocus>
